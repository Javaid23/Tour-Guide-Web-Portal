...
// Load Google credentials from Render secret file system (NEW FILE)
const credentialsPath = '/etc/secrets/client_secret_193682875788-ns09tjok4k48gi6bln1l5mn1beofk3la.apps.googleusercontent.com.json';
let credentials;
try {
